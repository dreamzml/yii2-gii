...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return $this->getBasePath().Yii::getAlias("/Shinho/Lib/Action/{$this->moduleName}/{$this->controllerClass}Action.class.php");
    }
    ...
    {
        return $this->getBasePath().Yii::getAlias("/tpl/{$this->moduleName}/default/{$this->controllerClass}_$action.html");
