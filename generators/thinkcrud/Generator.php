...
class Generator extends \yii\gii\Generator
{
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            foreach (scandir($templatePath) as $file) {
                if (is_file($templatePath . '/' . $file) && pathinfo($file, PATHINFO_EXTENSION) === 'php') {
                    ...
                    $files[] = new CodeFile("{$viewPath}/{$this->controllerClass}_{$fileName}", $this->render("views/$file", $params));
                }
            ...
            $modelPath = "{$viewPath}/{$this->controllerClass}Action.class.php";
    ...
    {
        return $this->getBasePath().Yii::getAlias("/Shinho/Lib/Action/{$this->moduleName}");
    }
    ...
    {
        return $this->getBasePath().Yii::getAlias("/Shinho/Lib/Model/{$this->moduleName}");
    }
    ...
    {
        return $this->getBasePath().Yii::getAlias("/tpl/{$this->moduleName}/default");
    }

    public function getBasePath(){
        return "E:/siteProgram/phpProject/xinhe_weixin_develop2";
    }
}
